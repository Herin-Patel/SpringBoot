package com.WebApplication.simpleEcom.controller;

import com.WebApplication.simpleEcom.model.Product;
import com.WebApplication.simpleEcom.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> searchProducts(@RequestParam String keyword) {
        ...
        List<Product> searchProducts = service.searchProducts(keyword);
